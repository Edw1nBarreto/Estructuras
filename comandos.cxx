...
void mostrarAyudaComando(Comandos comando) {
    switch(comando) {
        case CARGAR:
            ...
            cout << "DESCRIPCION: Carga en memoria los datos contenidos por nombre_archivo" << endl;
            cout << "SINTAXIS: cargar <nombre_archivo>" << endl;
            cout << "EJEMPLO: cargar secuencia.fasta" << endl;
            break;
        case LISTAR_SECUENCIAS:
            cout << "COMANDO: listar_secuencias" << endl;
            cout << "DESCRIPCION: Imprime la cantidad de secuencias actualmente en memoria y la informacion                            basica de cada secuencia." << endl;
            cout << "SINTAXIS: listar_secuencias" << endl;
            cout << "EJEMPLO: listar_secuencias" << endl;
            break;
        case HISTOGRAMA:
            cout << "COMANDO: histograma" << endl;
            cout << "DESCRIPCION: Imprime el histograma de una secuencia, en caso de que no exista." << endl;
            cout << "SINTAXIS: histograma <descripcion_secuencia>" << endl;
            cout << "EJEMPLO: histograma seq1" << endl;
            break;
        case ES_SUBSECUENCIA:
            cout << "COMANDO: es_subsecuencia" << endl;
            cout << "DESCRIPCION: Verifica si una secuencia es subsecuencia de las secuencias cargadas en                             memoria." << endl;
        ...
        case BASE_REMOTA:
            ...
            cout << "DESCRIPCION: Para la base ubicada en la posicion [i ,j ] de la matriz de la secuencia descripcion_secuencia,"
                    "el comando busca la ubicacion de la misma base (misma letra) mas lejana dentro de la matriz. Para esta"
                    "base remota, el comando debe imprimir en pantalla su ubicacion, la secuencia de vertices (bases) que"
                    "describen la ruta entre la base origen y la base remota, y el costo total de la ruta, teniendo en cuenta"
                    "el peso que tiene cada conexion entre bases." << endl;
        ...
        case AYUDA:
            ...
            cout << "DESCRIPCION: Muestra informacion sobre los comandos disponibles" << endl;
